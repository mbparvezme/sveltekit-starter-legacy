<script>
  ...
  import { S, dashboardTitle } from "$lib/store"
...
<Navbar height="md" miniNavScrollAmount={false}>
  <h4 class="font-bold flex items-center">{@html $dashboardTitle}</h4>
  ...
  <Button label="LOGOUT" size="xs" textColor="default" cls="bg-transparent text-default" on:click={()=>logout()} />
